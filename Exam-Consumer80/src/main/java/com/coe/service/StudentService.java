...
public interface StudentService {
    ...
    public CommonResult<Boolean> save(@RequestBody Student student);
    ...
    /**返回全部没有加入班级的学生*/
    @GetMapping("/students/getStudentAll")
    public List<Student> getStudentAll();

    /**学生加入班级*/
    @PutMapping("/students/updateClass")
    public CommonResult<Boolean> updateClass(@RequestBody Student student);
